...
class BobPrimeApp(QMainWindow):
    ...
    def Tab_Devices(self) -> QWidget:
        ...
        if getattr(self, 'ldplayer_directory', None) is None:
            self.ldplayer_directory = "C:/"
        labeltop1 = QLabel("LDplayer Location")
        self.ldplayer_directory_box_top = QGroupBox()
        self.ldplayer_directory_vbox_top = QVBoxLayout(self.ldplayer_directory_box_top)
        labeltop2 = QLabel(self.ldplayer_directory)
        labeltop3 = QPushButton("Browse")
        self.ldplayer_directory_vbox_top.addWidget(labeltop2)
        ...
        if getattr(self, 'system_directory', None) is None:
            self.system_directory = "C:/"
        labelbottom1 = QLabel("System Location")
        self.system_directory_box_bottom = QGroupBox()
        self.system_directory_vbox_bottom = QVBoxLayout(self.system_directory_box_bottom)
        labelbottom2 = QLabel(self.system_directory)
        labelbottom3 = QPushButton("Browse")
        self.system_directory_vbox_bottom.addWidget(labelbottom2)
